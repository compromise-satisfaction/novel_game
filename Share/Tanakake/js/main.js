  ...
  game.onload = function(){
    ...
    var TitleScene = function(){
      ...
      if(Version_new){
        ...
        if(Setting_Flag[1]=="妥協"&&Setting_Flag[0]=="満足"&&Setting_Flag[2]=="未設定") Submit("テスト用");
        else if(Already);
        else {
          fetch(GAS,)
          .then(res => res.json())
    ...
    var MainScene = function(Return,Number){
      ...
      if(game.assets[conversion_url(Datas[5],"画像")]==undefined&&Datas[5]!="") Datas[5] = Foldar+"image/画像無.png";
