...
function Datas_load(width,height){
  fetch(GAS,
    {
      method: 'POST',
      body: ""
...
function Game_load(width,height){
  ...
  game.onload = function(){
    ...
    function Scene_loads(Number,Return,Item,Item_type){
      ...
      for (var i = 0; i < Inspect_DATAS.length; i++) {
        if(Number==Inspect_DATAS[i].シーン名){
          ...
          if(Inspect[1]) Inspect[1] = Inspect_DATAS[i].x座標1;
          if(Inspect[2]) Inspect[2] = Inspect_DATAS[i].y座標1;
          if(Inspect[3]) Inspect[3] = Inspect_DATAS[i].幅1;
          if(Inspect[4]) Inspect[4] = Inspect_DATAS[i].高さ1;
          if(Inspect[5]) Inspect[5] = Inspect_DATAS[i].移動先1;
          if(Inspect[6]) Inspect[6] = Inspect_DATAS[i].x座標2;
          if(Inspect[7]) Inspect[7] = Inspect_DATAS[i].y座標2;
          if(Inspect[8]) Inspect[8] = Inspect_DATAS[i].幅2;
          if(Inspect[9]) Inspect[9] = Inspect_DATAS[i].高さ2;
          if(Inspect[10]) Inspect[10] = Inspect_DATAS[i].移動先2;
          if(Inspect[11]) Inspect[11] = Inspect_DATAS[i].x座標3;
          if(Inspect[12]) Inspect[12] = Inspect_DATAS[i].y座標3;
          if(Inspect[13]) Inspect[13] = Inspect_DATAS[i].幅3;
          if(Inspect[14]) Inspect[14] = Inspect_DATAS[i].高さ3;
          if(Inspect[15]) Inspect[15] = Inspect_DATAS[i].移動先3;
          if(Inspect[16]) Inspect[16] = Inspect_DATAS[i].x座標4;
          if(Inspect[17]) Inspect[17] = Inspect_DATAS[i].y座標4;
          if(Inspect[18]) Inspect[18] = Inspect_DATAS[i].幅4;
          if(Inspect[19]) Inspect[19] = Inspect_DATAS[i].高さ4;
          if(Inspect[20]) Inspect[20] = Inspect_DATAS[i].移動先4;
          if(Inspect[21]) Inspect[21] = Inspect_DATAS[i].x座標5;
          if(Inspect[22]) Inspect[22] = Inspect_DATAS[i].y座標5;
          if(Inspect[23]) Inspect[23] = Inspect_DATAS[i].幅5;
          if(Inspect[24]) Inspect[24] = Inspect_DATAS[i].高さ5;
          if(Inspect[25]) Inspect[25] = Inspect_DATAS[i].移動先5;
    ...
    var TitleScene = function(){
      ...
      Title._element.src = Title_image;
      Title.width = width;
