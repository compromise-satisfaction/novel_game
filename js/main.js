    ...
    function Scene_loads(Number,Return,Item,Item_type){
      ...
      for (var i = 0; i < Inspect_DATAS.length; i++) {
        if(Number==Inspect_DATAS[i].シーン名){
          ...
          if(Inspect_DATAS[i].x高さ1) Inspect[4] = Inspect_DATAS[i].x高さ1
          ...
          if(Inspect_DATAS[i].x高さ2) Inspect[9] = Inspect_DATAS[i].x高さ2
          ...
          if(Inspect_DATAS[i].x高さ3) Inspect[14] = Inspect_DATAS[i].x高さ3
          ...
          if(Inspect_DATAS[i].x高さ4) Inspect[19] = Inspect_DATAS[i].x高さ4
          ...
          if(Inspect_DATAS[i].x高さ5) Inspect[24] = Inspect_DATAS[i].x高さ5
